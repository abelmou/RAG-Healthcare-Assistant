...
st.markdown("""
    <div class="section">
        ...
        <a href="http://localhost:8504" class="link" target="_blank">قرا أكثر</a>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div class="section">
        ...
        <a href="http://localhost:8000" class="link" target="_blank">بدا الشات</a>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div class="section">
        ...
        <a href="http://localhost:8503" class="link" target="_blank">حدد الصيدلية</a>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div class="section">
        ...
        <a href="http://localhost:8502" class="link" target="_blank">اكتشف أكثر</a>
    </div>
""", unsafe_allow_html=True)
